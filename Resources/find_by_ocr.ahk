...
;Récupération de l'argument passé via la fonction LoginHelper.FindByOcr()

Text:=A_Args[1]

t1:=A_TickCount, X:=Y:="#"

if (ok:=FindText(1641-150000, 806-150000, 1641+150000, 806+150000, 0, 0, Text))
{
  CoordMode, Mouse
...
;  . "`n`Looking for " . Server
;  . "`n`Data : " . Text
;}else {
;  MsgBox, 4096, Tip, % "Fail", 4000]
;}
